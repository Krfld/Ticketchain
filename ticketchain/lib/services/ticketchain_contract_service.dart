...
class TicketchainContractService {
  static DeployedContract ticketchainContract() => DeployedContract(
        ContractAbi.fromJson(_ticketchainAbi, 'Ticketchain'),
        EthereumAddress.fromHex(_address),
      );

  static DeployedContract eventContract(String address) => DeployedContract(
